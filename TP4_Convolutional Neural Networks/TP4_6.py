...
def TP4_6a():
	...
	for train_index, test_index in kf.split(data):
		...
		c1 = layers.Dense(50, activation=activations.relu, kernel_regularizer=regularizer.l2(0.01))(input)
		c1 = layers.Dense(50, activation=activations.relu, kernel_regularizer=regularizer.l2(0.01))(c1)
		c1 = layers.Dense(50, activation=activations.relu, kernel_regularizer=regularizer.l2(0.01))(c1)
		out = layers.Dense(1, activation=activations.sigmoid, kernel_regularizer=regularizer.l2(0.01))(c1)
