import numpy as np
import Old.TP2_6.losses as losses
import Old.TP2_6.optimizers as optimizers
import Old.TP2_6.metrics as metrics
import Old.TP2_6.regularizers as reg
...
class Network:
	...
	def print(self):
		plt.figure(1)
		plt.plot(self.epoca_arr, self.acc_train, 'b*-')
		if self.tdata:
		...
		plt.ylabel('Accuracy')
		plt.ylim(0, 100)
		plt.savefig('TP2_6_acc.pdf')
		plt.figure(2)
		plt.plot(self.epoca_arr, self.loss_train, 'b*-')
		if self.tdata:
